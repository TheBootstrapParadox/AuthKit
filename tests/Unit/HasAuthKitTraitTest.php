...
class HasAuthKitTraitTest extends TestCase
{
    ...
    {
        config(['authkit.two_factor.required_for_roles' => ['admin']]);
    ...
    {
        config(['authkit.two_factor.required_for_roles' => []]);
    ...
    {
        config(['authkit.passkey.required_for_roles' => ['admin']]);
    ...
    {
        config(['authkit.rbac.super_admin_role' => 'super-admin']);
