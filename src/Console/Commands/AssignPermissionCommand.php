...
namespace BSPDX\AuthKit\Console\Commands;

use BSPDX\AuthKit\Console\Commands\Concerns\InteractsWithAuthKit;
...
class AssignPermissionCommand extends Command
{
    ...
    protected $signature = 'authkit:assign-permission
    ...
    protected function assignToRole(string $roleName, array $permissions): int
    {
        ...
        $role = AuthKitRole::where('name', $roleName)
