...
namespace BSPDX\AuthKit\Console\Commands\Concerns;
...
trait InteractsWithAuthKit
{
    ...
    {
        return config('authkit.rbac.multi_tenant', false);
    }
    ...
    {
        return config('authkit.rbac.super_admin_role', 'super-admin');
    }
    ...
    {
        return config('authkit.rbac.default_role');
    }
